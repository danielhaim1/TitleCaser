...
describe('TitleCaser – Disambiguation of Acronym vs. Pronoun (AP Style)', () => {
    ...
    runTest(
        'should capitalize "US" after "from the"',
        'Support came from the us',
        'Support Came From the US'
    );
    runTest(
        'should capitalize "US" after "via"',
    ...
    //
    runTest(
        'should capitalize pronoun "us" (case #1)',
    ...
    runTest(
        'should capitalize pronoun "us" (case #3)',
        'partner with us',
        'Partner With Us'
    );
    ...
    runTest(
        'should capitalize pronoun "us" (repeat case #2)',
        'You can partner with us.',
        'You Can Partner With Us.'
    );
    runTest(
    ...
    //
    runTest(
        'should handle "On & Off" phrases #1',
