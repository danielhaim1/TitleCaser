...
const { toTitleCase } = require('../api/titleCase.js');
...
describe('String.prototype.toTitleCase', () => {
    ...
    test("Reserved keyword (jQuery, Frontend)", () => {
        ...
        expect(myString.toTitleCase({ style: "chicago" })).toBe("jQuery Plugins for Front-End Developers: A Comprehensive Guide");
    });
    ...
    test("Convert string to title case with AP style formatting, including special terms such as eBook, CTO", () => {
        ...
        expect(myString.toTitleCase({ style: "ap" })).toBe("Revolutionizing the Publishing Industry: Insights From a CTO on eBook Development and Innovation");
    });
    ...
    test("Convert string to title case with NYT style formatting, including special terms such as IoT, AI", () => {
        ...
        expect(myString.toTitleCase({ style: "nyt" })).toBe("The Future of AI: How IoT and Machine Learning Will Change the World");
    });
    ...
    test("Convert string to title case with APA style formatting, including colon and short conjunctions", () => {
        ...
        expect(myString.toTitleCase({ style: "apa" })).toBe("The Impact of Social Media on Mental Health: A Study of Instagram and Snapchat");
    });
    ...
    test("Convert string to title case with Wikipedia style formatting, including special terms such as DevOps", () => {
        ...
        expect(myString.toTitleCase({ style: "wikipedia" })).toBe("The Future of DevOps: How to Prepare for the Next Era of Software Development");
    });
    ...
    test("Convert string to title case with Chicago style formatting, including reserved terms GooGlE to Google", () => {
        ...
        expect(myString.toTitleCase({ style: "chicago" })).toBe("Google vs. VirtualBox: A Comparative Study of Virtualization Software");
    });


    // test("Convert string to title case with Chicago style formatting, including reserved terms", () => {
  
    //     const myReservedTerms = ["eSignature", "eSign"];
    //     const myString = "ESignature vs. Esign: a comparative study of digital signature software";
    //     const result = myString.toTitleCase({ style: "chicago", reservedTerms: myReservedTerms });

    //     expect(
            
            
    //         .toBe("eSignature vs. eSign: A Comparative Study of Digital Signature Software"));
    // }); 
